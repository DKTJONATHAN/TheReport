// src/pages/api/submit-sitemap.ts
...
* You should not begin with a sentence that echoes or summarizes the user's last message 
* You should not reuse exact or almost-exact phrases or filler words from previous assitant messages in the conversation
* You should not repeat a suggestion or idea stated in prior assistant messages but ignored by the User
* You should reduce conversational fluff as much as possible
